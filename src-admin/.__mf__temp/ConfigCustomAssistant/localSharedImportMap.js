...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "@emotion/react": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__ConfigCustomAssistant__prebuild___mf_0_emotion_mf_1_react__prebuild__.js");
            return pkg;
        }
      ,
        "@emotion/styled": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__ConfigCustomAssistant__prebuild___mf_0_emotion_mf_1_styled__prebuild__.js");
            return pkg;
        }
      ,
        "@iobroker/adapter-react-v5": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__ConfigCustomAssistant__prebuild___mf_0_iobroker_mf_1_adapter_mf_2_react_mf_2_v5__prebuild__.js");
            return pkg;
        }
      ,
        "@iobroker/json-config": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__ConfigCustomAssistant__prebuild___mf_0_iobroker_mf_1_json_mf_2_config__prebuild__.js");
            return pkg;
        }
      ,
        "@mui/icons-material": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__ConfigCustomAssistant__prebuild___mf_0_mui_mf_1_icons_mf_2_material__prebuild__.js");
            return pkg;
        }
      ,
        "@mui/material": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__ConfigCustomAssistant__prebuild___mf_0_mui_mf_1_material__prebuild__.js");
            return pkg;
        }
      ,
        "react": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__ConfigCustomAssistant__prebuild__react__prebuild__.js");
            return pkg;
        }
      ,
        "react-dom": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__ConfigCustomAssistant__prebuild__react_mf_2_dom__prebuild__.js");
            return pkg;
        }
      ...
      const usedShared = {
          ...
          "@emotion/react": {
            ...
            scope: ["default"],
            loaded: false,
            from: "__mfe_internal__ConfigCustomAssistant",
            async get () {
              if (false) {
